...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains the date, longitude and latitudes from 2018 to 2023 for around 62 thousand records for the conflicts in Brazil among other factors such as event types such as protest or violence or battles or other things like Riots</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains the date, longitude and latitude from 1989 to 2018 for around 6 thousand records for the conflicts in Pakistan among other factor such as the number of deaths and information regarding the conflict outcomes</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains the date, longitude and latitude for around from 2014 to 2019 for around 1 thousand records for the conflicts in Ukraine among other factors such as the number of deaths and other relevant information to the conflict</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains the date, longitude and latitude from 1988 to 2017 for around 800 records for the world fireballs that are exceptionally bright that are spectacular enough to be seen over a very wide area in the sky. Only the brightest fireballs are recorded.</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains the date, longitude and latitude for New York City Shooting from 2006 to 2019 for around 22 thousand records among relevant information to the incident such as the shooter (age, gender, race).</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains the date, and the location is country level locations of the incident for around 5 thousand records from 1908 to 2020 among relevant information such as casualties, the operator whether private or else.</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains the date and country level locations from 2013 to 2022 for around 472 thousand records for gun violence incidents and mass shooting in the USA.</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains the date, longitude and latitude from 2016 to 2021 for around 3 milion records for traffic congestion in the USA among relevant information such as the severity of the congestion</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains the date, longitude and latitude from 1900 to 2023 for around 2 thousand records of tsunamis around the world among relevant information such as the magnitude of each event, impact of the tsunami such as the number of deaths and injuries.</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains the date, longitude and latitude from 1300 to 2021 for around 200 records of volcanos in Indonesia among relevant information such as imapcts like the number of houses destroyed</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains date, longitude and latitude from 1900 to 2021 for around 16 thousand records of various types of natural disasters in the world such as droughts, volcanos, earhtquakes among relevant information such as the number of people injured, total deaths and damages costs</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains date, country level locations from 2000 to 2023 for around 650 thousand records for the air quality in the United States based on on pollutants like Carbon Monoxide (CO), and Ozone (O3) and others.</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains year, county level location from 2016 to 2021 years for the USA County Population, it contains measurements for 3222 different locations</p>
...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;">This dataset contains year and country level location from 200 to 2015 for the rates of suicide around the glob </p>
