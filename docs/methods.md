...
<div style="display: flex; justify-content: space-between; align-items: stretch; margin-bottom: 20px;">
    <div style="display: flex; align-items: stretch;">
      ...
      <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <p style="margin: 0;"><a href="https://rss.onlinelibrary.wiley.com/doi/abs/10.1111/rssb.12548?casa_token=_H1UgDzbByIAAAAA:fNsySp_LVarUYfAfCI9kcmdCPPoYWryPRDQ-ljitjDyrbw7zUeZ6xS1OTaha0ao48plzEP1RBBD1u_Lp&casa_token=CX9tQaeDcK8AAAAA:N4XCcnVsVrZCSGuUx-YgFrY0vosPtDTNTRCsj0W-g-igE4_G_hXG21TzWgcBUEVCKABbXdaZAJeyXmVA"><i class="fa-regular fa-file-pdf"></i>https://rss.onlinelibrary.wiley.com/doi/abs/10.1111/rssb.12548?casa_token=_H1UgDzbByIAAAAA:fNsySp_LVarUYfAfCI9kcmdCPPoYWryPRDQ-ljitjDyrbw7zUeZ6xS1OTaha0ao48plzEP1RBBD1u_Lp&casa_token=CX9tQaeDcK8AAAAA:N4XCcnVsVrZCSGuUx-YgFrY0vosPtDTNTRCsj0W-g-igE4_G_hXG21TzWgcBUEVCKABbXdaZAJeyXmVA</a> </p>
      </div>
    </div>
    <!-- <div style="color: lightgray; align-self: flex-start; margin-left: 10px; white-space: nowrap; font-size: 200%;">2022</div>  -->
  </div>
